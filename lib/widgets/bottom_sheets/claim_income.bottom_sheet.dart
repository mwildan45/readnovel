...
Future<dynamic> claimIncomeBottomSheet(BuildContext context, IncomeViewModel viewModel) {
                ...
                child: VStack(
                  [
                    CustomTextFormField(
                      ...
                      maxLines: 1,
                      radius: 10,
                      validator: (val) => FormValidator.validateEmpty(val, errorTitle: 'Jumlah Penarikan'),
                    ),
                    12.height,
                    CustomButton(
